...
$Datafasilitas = New FasilitasHotel;
$datanya=[  'nama_fasilitas'=>$this->request->getPost('txtInputNama'),   
        ...
        public function updatefasilitasHotel(){
            ...
            helper(['form']);
            $data=[
                'nama_fasilitas_hotel'=>$this->request->getPost('txtInputNama'), 
                'deskripsi'=>$this->request->getPost('txtInputDeskripsi'),
            ];
            $Datafasilitas->update($this->request->getPost('id_fasilitas_hotel'), $data);
            return redirect()->to('/fasilitas-hotel');
            }
