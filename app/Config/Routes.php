...
$routes->get('/fasilitas-kamar', 'FasilitasKamarController::tampilfasilitaskamar');
...
$routes->get('/fasilitas-kamar/editfoto/(:num)', 'FasilitasKamarController::editfoto/$1');
$routes->post('/fasilitas-kamar/updatefoto', 'FasilitasKamarController::updatefoto');
