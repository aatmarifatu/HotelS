...
class="form-control" placeholder="Masukan Deskripsi Kamar" value="<?=$detailKamar[0]['jumlahkamar'];?>" >
</div>
<div class="form-group">
<label class="font-weight-bold">Deskripsi kamar</label>
<input type="textarea" name="txtInputDeskripsi"
class="form-control" placeholder="Masukan Jumlah" value="<?=$detailKamar[0]['deskripsi'];?>" >
</div>
<div class="form-group">
